<template>
  <div>
      ...
      <div class="container" flexcontainer>
        ...
        <ul class="block-item" w-369>
          <li>
            ...
            <figcaption>
              <h2><span class="bable">新品</span>客家话卡加扣水电费</h2>
              <div>
                <span><i>￥</i>21</span> 193人付款
              </div>
            </figcaption>
    ...
    <div class="block block-5">
      <div class="container">
        <ul>
          <li flexcontainer v-for="i in [1,2,3]" :key="i">
            <figure w-324-324>
...
<style scoped>
  ...
  [w-369] i {
    font-size: 20px;margin-right: 5px;font-style: normal;
  }
  ...
  .block-5 h2{
    font-size: 32px;font-weight: 400;margin: 0 0 20px;
  }
  .block-5 figcaption p{
    font-size: 30px;color: #999;overflow: hidden;
